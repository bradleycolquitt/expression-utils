...
seurat_integrate_plots = function(obj_list, obj_int, plot_dir=NULL, groups_to_plot = c("celltype_comb", "celltype2", "dataset")) {
    ...
    to_plot = FetchData(obj_list[[2]], "celltype2")
